program main
   ...
   do i=1,n
      do j=i+1,n
         block
            real(16)::a(2,2),b(2),work(2)
            integer::ipiv(2)
            !x1 + v1 * t1 = x2 + v2 * t2
            !v1 * t1 - v2 * t2 = x2 - x1
            a(1,:)=[real(16)::v(1,i),-v(1,j)]! [t1]
            a(2,:)=[real(16)::v(2,i),-v(2,j)]! [t2]
            b(1)=x(1,j)-x(1,i)
            b(2)=x(2,j)-x(2,i)
   ...
   block
      ...
      associate(v1=>v(:,1:3),x1=>(x(:,1:3)))
         associate(v21=>v(:,2)-v(:,1),&
               ...
               x12=>x(:,1)-x(:,2),&
               x23=>x(:,2)-x(:,3))
            a(1,:)=[real(16)::      0,-v21(3), v21(2),      0,-x12(3), x12(2)]
            a(2,:)=[real(16):: v21(3),      0,-v21(1), x12(3),      0,-x12(1)]
            a(3,:)=[real(16)::-v21(2), v21(1),      0,-x12(2), x12(1),      0]
            a(4,:)=[real(16)::      0,-v32(3), v32(2),      0,-x23(3), x23(2)]
            a(5,:)=[real(16):: v32(3),      0,-v32(1), x23(3),      0,-x23(1)]
            a(6,:)=[real(16)::-v32(2), v32(1),      0,-x23(2), x23(1),      0]

            b(1:3)= [real(16)::cross(x(:,1),v(:,1))-cross(x(:,2),v(:,2))]
            b(4:6)= [real(16)::cross(x(:,2),v(:,2))-cross(x(:,3),v(:,3))]
...
contains
   ...
   logical function inv (b,n,work,ipiv) result(res)
      implicit none
      integer,intent(in)   :: n
      real(16),intent(inout):: b(n,n)
      real(16),intent(inout):: work(n)
